                    ...
                    <Row className='project-wrapper-header-row'>
                        <Row className='project-wrapper-header-row-row'>
                            ...
                            <Col className='project-wrapper-header-row-row-description'>
                                ...
                                <a href="https://github.com/Nitingoyal2/shark_tank" target="_blank" rel="noopener noreferrer"><Button className='button'>View Project</Button></a>
                            </Col>
                        ...
                        <Row className='project-wrapper-header-row-row'>
                            ...
                            <Col className='project-wrapper-header-row-row-description'>
                                ...
                                <p className='project-description'>
                                    A currency converter is a digital tool designed to facilitate the conversion of one currency to another based on current exchange rates. It enables users to quickly and accurately determine the equivalent value of a specific amount in different currencies, aiding in international transactions, travel planning, and financial management. Technologies used - HTML, CSS, Bootstrap, JavaScript, ReactJS </p>
                                <a href="https://nitingoyal2.github.io/currencyconverter/" target="_blank" rel="noopener noreferrer"><Button className='button'>View Project</Button></a>
                            </Col>
